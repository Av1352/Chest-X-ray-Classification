...
if submitted and uploaded_file is not None:
    ...
    gradcam_image.save("temp_gradcam.png")
    pdf_bytes = build_pdf_report(name, age, exam_date, diagnosis, confidence, "temp_xray.png", "temp_gradcam.png")

    st.download_button(
        "Download AI Report (PDF)", 
        pdf_bytes, 
        file_name=f"ChestXrayReport_{name.replace(' ', '_')}.pdf"
    )
